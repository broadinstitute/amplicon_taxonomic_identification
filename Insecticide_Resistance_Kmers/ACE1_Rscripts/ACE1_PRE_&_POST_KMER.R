...
write.csv(RC50_10, file= "ACE1_RC50_10.csv", row.names = F)
...
#-------------------------------------------------------------------------
kmertest<- read.table("ACE1_R7-9.txt", header = TRUE, sep = "\t")

#-------------------------------------------------------------------------
#loading our dataframe with the read count and asv ID per mosquito sample.
#-------------------------------------------------------------------------

DF3 <- read.csv("ACE1_RC50_10.csv")
...
write.csv(to_save, file= "ACE1_Resistance_report.csv", row.names = F)
